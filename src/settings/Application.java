...
import objects.FloatingMessage;
...
public class Application {
    ...
    public static void showMessage(String message, long length, boolean disposable) {
    ...
    public static void showMessage(String message, 
    		Component parent, int pointOnParent, long length, boolean disposable) {
    	Main.setWindowDecorations(false);
    	if (popup != null) {
    		popup.dispose();
    	}
    ...
    private static void setPopupLocation(Component parent, int pointOnParent) {
    	if(pointOnParent == FloatingMessage.TOP_LEFT) {
    		popup.setLocation(new Point(parent.getLocationOnScreen().x - popup.getWidth(),
    				parent.getLocationOnScreen().y - popup.getHeight()));
    	} else if (pointOnParent == FloatingMessage.TOP_RIGHT) {
    		popup.setLocation(new Point(parent.getLocationOnScreen().x + parent.getWidth(),
    				parent.getLocationOnScreen().y - popup.getHeight()));
    	} else if (pointOnParent == FloatingMessage.BOTTOM_RIGHT) {
    		popup.setLocation(new Point(parent.getLocationOnScreen().x + parent.getWidth(),
    				parent.getLocationOnScreen().y + parent.getWidth()));
